  ...
  return (
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        <title>fork</title> <desc>Created with sketchtool.</desc>{" "}
        <g
          id="production"
          stroke="none"
          strokeWidth="1"
